...
export default function StickyHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white md:bg-white/95 md:backdrop-blur-sm border-b border-border will-change-transform transform-gpu" data-testid="header-main">

      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-12">
          ...
          <div data-testid="section-quick-links">
            <h3 className="font-semibold text-lg mb-5 md:mb-4 tracking-wide" style={{color: '#1a202c'}} data-testid="heading-quick-links">Quick Links</h3>
          ...
          <div data-testid="section-contact-info">
            <h3 className="font-semibold text-lg mb-5 md:mb-4 tracking-wide" style={{color: '#1a202c'}} data-testid="heading-contact">Contact</h3>

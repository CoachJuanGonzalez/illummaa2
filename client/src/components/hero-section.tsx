  ...
  return (
    <section className="relative min-h-screen flex items-center" data-testid="section-hero">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src="https://images.unsplash.com/photo-1582268611958-ebfd161ef9cf?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1920&h=1080" 
          alt="Modern modular home exterior" 
